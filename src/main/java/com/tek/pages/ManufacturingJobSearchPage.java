...
public class ManufacturingJobSearchPage extends Page{
	...
	public ManufacturingJobSearchPage() {
	...
	public boolean searchManufacturingJob(String role) throws InterruptedException {
