...
public class FacilitiesJobSearchPage extends Page{
	...
	public FacilitiesJobSearchPage() {
	...
	public boolean searchFacilitiesJob(String role) throws InterruptedException {
